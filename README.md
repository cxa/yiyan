...
Latest version: `260729.0`. See the [release notes](RELEASE_NOTES.md) for changes in every version.
<!-- release-summary-en:end -->

**Direct download**

<!-- release-download-en:start -->
Download [`YiYan-260729.0.dmg`](https://github.com/cxa/yiyan/releases/download/v260729.0/YiYan-260729.0.dmg) (SHA-256: `f74b6f151be07a5d6e50ca5e5d9513746b909a5cfa8e5aa64a7a9463452b0537`)
<!-- release-download-en:end -->

1. Download the `YiYan-260729.0.dmg` shown above.
...
最新版本：`260729.0`。每个版本的更新内容请查看[发行说明](RELEASE_NOTES.md)。
<!-- release-summary-zh:end -->

**直接下载**

<!-- release-download-zh:start -->
下载 [`YiYan-260729.0.dmg`](https://github.com/cxa/yiyan/releases/download/v260729.0/YiYan-260729.0.dmg)（SHA-256：`f74b6f151be07a5d6e50ca5e5d9513746b909a5cfa8e5aa64a7a9463452b0537`）
<!-- release-download-zh:end -->

1. 下载上方列出的 `YiYan-260729.0.dmg`。
